 ...
 /* You Can Edit | Delete Members From Here */
                ...
                <div class="panel panel-default">
                    ...
                    <div class="card-footer">
                     <ul class="list-unstyled latest-users">
                       <span class="form-control" style="background-color: white;padding: 13px;"><a href="managePayment.php" style="text-decoration: none;position: absolute;top: 2px;cursor: pointer;color: black;">Manage Payment </a> </span>
                        <span class="form-control" style="background-color: #3Babc3;padding: 13px; margin-top: 10px;"><a href="manageStudentPayment.php" style="text-decoration: none;position: absolute;top: 2.5px;color: white;">Manage Student Payment</a></span>
                     </ul>
                    </div>
                </div>
              </div>
                ...
                <?php
                 foreach ($rows as $row) {
                    echo "<tr>";
                      ...
                      echo "<td>
                              <a href='manageStudentPayment.php?do=Edit&payid=" .$row['Payment_ID'] . "' class='btn btn-success'><i class='fa fa-edit' style='margin-right:3px;'></i>Edit</a>
                              <a href='manageStudentPayment.php?do=Delete&payid=" .$row['Payment_ID'] . "' class='btn btn-danger confirm'><i class='fa fa-close' style='margin-right:4px;'></i>Delete </a>";

                            if($row['Status'] == 0){
                             echo  "<a href='manageStudentPayment.php?do=Activate&payid=" .$row['Payment_ID'] . "' class='btn btn-info activate' style='margin-left:5px;'><i class='fa fa-check' style='margin-right:4px;'></i>Paid</a>";
  ...
  <?php  
      ...
      //The Row Count
       ...
       echo "<h1 class='text-center' style='margin-top: 100px;color:#888;font-size: 55px;font-weight: bold'>Paid Student</h1>";
       echo "<div class='container'>";
      ...
      //Select all Data Depend On ID
       ...
       $check = checkItem('Payment_ID' , 'student_payment' , $payid);
     ...
     //  $count = $stmt->rowCount();
        ...
        if($check > 0){   
         ...
         $stmt = $con->prepare("UPDATE student_payment SET Status = 1 WHERE Payment_ID = ? ");
